...
// lease so a later Claim retries the task; terminal=true parks it as a dead
// letter. When a lease no longer matches — because it expired and another
...
//     consumer may reclaim it (default 5m). NewInMem takes the same timeout as a
//     plain argument.
